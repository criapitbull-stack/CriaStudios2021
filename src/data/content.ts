export const SLIDES = [
  {
    image: 'https://images.pexels.com/photos/13229846/pexels-photo-13229846.jpeg?auto=compress&cs=tinysrgb&w=1600',
    title: 'Sua liberdade começa em casa',
    subtitle: 'Trabalhe como modelo de webcam no conforto do seu lar e ganhe em moedas reais',
  },
  {
    image: 'https://images.pexels.com/photos/30138572/pexels-photo-30138572.jpeg?auto=compress&cs=tinysrgb&w=1600',
    title: 'Seu horário, suas regras',
    subtitle: 'Escolha quando transmitir e construa sua renda no seu ritmo',
  },
  {
    image: 'https://images.pexels.com/photos/15674300/pexels-photo-15674300.jpeg?auto=compress&cs=tinysrgb&w=1600',
    title: 'Equipamento profissional não é barreira',
    subtitle: 'Comece com o celular ou notebook que você já tem',
  },
  {
...
export const ROTATING_CTAS = [
  'Quero ser modelo',
  'Quero ganhar dinheiro na internet',
  'Quero renda extra',
  'Quero ser camgirl',
  'Quero trabalhar em casa',
  'Quero ser modelo de webcam',
  'Quero minha independência financeira',
  'Quero começar agora',
];
...
export const FAQS = [
  ...
  },
  {
    ...
    a: 'Não. A Cria Studios oferece todo o suporte e cadastra você nas principais plataformas. Basta ter 18 anos ou mais, um celular ou notebook com câmera de boa qualidade e tempo livre.',
  },
  {
  ...
  },
  {
    ...
    a: 'Sim. O trabalho com webcam adulta é permitido apenas para maiores de 18 anos. A verificação de idade é obrigatória nas plataformas.',
  },
  {
  ...
  },
  {
    ...
    a: 'Não. O cadastro e o suporte da Cria Studios são gratuitos. A renda vem das plataformas onde você transmite.',
  },
  {
    q: 'Posso trabalhar em qualquer país?',
    a: 'Sim. A Cria Studios atende modelos internacionalmente. O trabalho é remoto — você transmite de onde estiver, basta internet e câmera.',
  },
  {
    q: 'Meus dados ficam protegidos?',
    a: 'Sim. Seus dados são tratados com sigilo e usados apenas para o cadastro nas plataformas. Não compartilhamos suas informações com terceiros.',
  },
];
...
export const SEO_CONTENT = [
  ...
  {
    heading: 'Vaga home office: por que o trabalho com webcam é a renda extra ideal',
    paragraphs: [
      'O home office deixou de ser uma exceção e virou regra para milhões de pessoas. Mas enquanto a maioria das vagas home office oferece salários fixos e limitados, o trabalho como camgirl oferece um teto de ganhos que depende apenas de você. Quanto mais você transmite, mais você ganha. Quanto mais você constrói sua audiência, mais fãs recorrentes você tem, e mais moedas e gorjetas chegam.',
      'A flexibilidade é outro grande atrativo. Você escolhe os horários, os dias, a duração das transmissões. Não há meta imposta, não há chefe cobrando, não há ponto para bater. É a renda extra perfeita para quem quer conciliar com estudos, outra atividade, ou para quem quer transformar a renda extra em renda principal.',
      'A Cria Studios atua como sua agência e parceira. Nós não somos uma plataforma — somos o estúdio que conecta você às plataformas, faz o cadastro, orienta sobre melhores práticas, e fica disponível pelo chat para tirar dúvidas e acompanhar seu desenvolvimento. É como ter um gerente de carreira, sem custo para você.',
    ],
  },
  {
  ...
  {
    heading: 'Ganhar dinheiro em casa: mitos e verdades sobre ser camgirl',
    paragraphs: [
      'Existem muitos mitos sobre o trabalho como camgirl. O primeiro é que é preciso mostrar o rosto. Não é — muitos modelos trabalham com máscaras, ângulos que preservam a identidade, ou em plataformas que permitem transmissões sem identificação. O segundo mito é que é preciso investimento. Não é — um celular com boa câmera é suficiente para começar.',
      'O terceiro mito é que é ilegal. Não é — o trabalho com webcam adulta, para maiores de 18 anos, em plataformas legalizadas, é uma atividade lícita e regulamentada. O quarto mito é que os ganhos são baixos. Não são — a média de ganhos de um modelo dedicado, transmitindo regularmente em duas ou mais plataformas, supera significativamente a renda da maioria das vagas formais.',
      'A verdade é que ser camgirl é um trabalho como qualquer outro: exige dedicação, consistência e profissionalismo. A diferença é que você é dona do seu tempo, do seu espaço e dos seus ganhos. A Cria Studios está aqui para tornar esse caminho mais simples, seguro e lucrativo para você.',
    ],
  },
  {
    heading: 'Renda extra online para mulheres: independência financeira e liberdade',
    paragraphs: [
      'A independência financeira é o objetivo de milhões de mulheres. A renda extra online, através do trabalho com webcam, se tornou um caminho concreto para essa independência. Sem depender de patrão, sem horário fixo, sem teto de ganhos, e com a possibilidade de trabalhar de qualquer lugar do mundo.',
      'A Cria Studios atende modelos internacionalmente. O suporte é 100% online, pelo chat, e o cadastro nas plataformas é feito pela nossa equipe. Você não precisa se deslocar, não precisa comparecer a entrevistas, não precisa enviar documentos por e-mail — tudo acontece de forma simples e segura pelo nosso chat.',
      'Se você é maior de 18 anos, tem um celular ou notebook com câmera, e quer transformar seu tempo livre em renda real, fale com a Cria Studios agora mesmo pelo chat. Não há compromisso, não há custo, e o primeiro passo é apenas uma conversa.',
    ],
  },
];
